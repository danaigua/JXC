...
public class CustomerReturnListGoods {
	...
	public String toString() {
		return "CustomerReturnListGoods [id=" + id + ", customerReturnList=" + customerReturnList + ", code=" + code + ", name=" + name + ", model="
				+ model + ", type=" + type + ", goodsId=" + goodsId + ", unit=" + unit + ", price=" + price + ", num="
				+ num + ", total=" + total + ", typeId=" + typeId + "]";
	}
